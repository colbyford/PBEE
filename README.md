...
2. Run the Docker container:
   ...
   # docker run --gpus all --rm -v ./trainedmodels:/software/PBEE/trainedmodels --name pbee -it cford38/pbee:latest /bin/bash
   ```
> [!NOTE]
> This image does not include the model weights. You can download them locally and mount the directory in the container under `/software/PBEE/trainedmodels`.
